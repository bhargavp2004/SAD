...
plt.title('Training and Validation Accuracy for CONV2D+CONVLSTM2D+LSTM ')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.legend()
plt.show()
...
plt.title('Training and Validation Loss for CONV2D+CONVLSTM2D+LSTM ')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
plt.show()
...
print(f'Test Accuracy (CONV2D+CONVLSTM2D+LSTM): {test_accuracy:.4f}')
...
model.save("Suspicious_Human_Activity_Detection_CONV2D+CONVLSTM2D+LSTM.keras")

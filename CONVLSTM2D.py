...
plt.title('Training and Validation Accuracy for CONVLSTM2D')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.legend()
plt.show()
...
plt.title('Training and Validation Loss for CONVLSTM2D')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
plt.show()
...
print(f'Test Accuracy (CONVLSTM2D): {test_accuracy:.4f}')
...
plt.title('Confusion Matrix For CONVLSTM2D')
plt.xlabel('Predicted Labels')
plt.ylabel('True Labels')
plt.show()

model.save("Suspicious_Human_Activity_Detection_CONVLSTM2D.keras")
